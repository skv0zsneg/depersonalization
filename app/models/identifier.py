...
class DepersonalizeDataForIdentifierMethod(db.Model):
    ...
    conformity_table_for_identifier_method_id = db.Column(
        db.Integer,
        db.ForeignKey("conformity_table_for_identifier_method.id"),
        nullable=False,
    )
...
class UnDepersonalizationDataForIdentifierMethod(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    fio = db.Column(db.String, nullable=False)
    birth_date = db.Column(db.String, nullable=False)
    birth_place = db.Column(db.String, nullable=False)
    ...
    def __init__(self, **kwargs):
        super(UnDepersonalizationDataForIdentifierMethod, self).__init__(**kwargs)
